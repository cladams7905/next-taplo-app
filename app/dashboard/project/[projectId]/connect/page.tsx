...
export default async function ConnectPage() {
  ...
  return (
    <div className="flex flex-col items-center justify-center gap-3 bg-gradient-to-tr from-primary/50 to-violet-100 h-screen-minus-navbar w-full md:px-24 sm:px-10">
      <IntegrationBoard
        events={events}
