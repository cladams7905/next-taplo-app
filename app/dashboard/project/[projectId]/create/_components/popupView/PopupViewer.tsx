...
export default function PopupViewer() {
  ...
  return (
    <div className="flex flex-col w-full items-center gap-3 py-4 rounded-lg">
      <div className="flex flex-col relative items-center rounded-lg gap-14 bg-white/40 shadow-md lg:min-w-[35vw] lg:w-fit w-full mb-12 mt-6 lg:my-0 md:my-0 pb-28 px-4">
