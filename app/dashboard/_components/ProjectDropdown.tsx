    ...
    <div className="flex flex-wrap items-center">
      <ul className="menu menu-horizontal w-fit">
        <div className="dropdown min-w-fit">
          ...
          <div
            className="dropdown-content right-[3px] md:left-0 lg:left-0 border mt-1 border-gray-300 dark:border-gray-600 z-30 p-2 shadow-lg bg-base-100 rounded-md w-52"
            ref={toggleElement}
            tabIndex={1}
          >
            <div
